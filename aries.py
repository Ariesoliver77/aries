...
def auto_create_page():
 # print('\n\x1b[1;92m[01]\x1b[0m \x1b[1;97mLogin with email and password\x1b[0m')
  ...
  try:
      ...
      i = 1
      while i <= quantity:
          page_name = requests.get('https://name.ariesoliver.repl.co/').json()['name']
...
if __name__ == "__main__":
      try:
              ...
              while True:
                print('\n\x1b[1;92m' + '-' * 50 + '\x1b[0m')
                print('\n\x1b[1;92mOwner     :\x1b[0m \x1b[1;97mAriesOliver\x1b[0m ')
                print('\x1b[1;92mFacebook  :\x1b[0m \x1b[1;97mhttps://www.facebook.com/Ariesoliver77\x1b[0m ')
                print('\x1b[1;92mTool Type :\x1b[0m \x1b[1;97mFacebook Manager\x1b[0m ')
                print('\x1b[1;92mVersion   :\x1b[0m \x1b[1;97m1.1\x1b[0m ')
                print('\n\x1b[1;92m' + '-' * 50 + '\x1b[0m')
